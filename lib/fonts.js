...
export default css.global`
  @font-face {
    ...
    font-display: block;
    src: url(https://res.cloudinary.com/dmbfslxdl/raw/upload/v1589579098/fonts/NeueHaasDisplay-Light_qwblaz.woff2)
      format('woff2');
  }
  ...
  @font-face {
    ...
    font-display: block;
    src: url(https://res.cloudinary.com/dmbfslxdl/raw/upload/v1589579097/fonts/NeueHaasDisplay-Mediu_k4csup.woff2)
      format('woff2');
  }
